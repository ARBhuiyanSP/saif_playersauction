                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    <h4 class="m-t-0 header-title"><b>Division List</b>
									<button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal">Add New Division</button></h4>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
										...
										<?php
											$result = $DB->prepare("SELECT * FROM division");
                                        ...
                                        <tr>
											...
											$resultc = $DB->prepare("SELECT * FROM country where `id`='$country_id'");
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													<li><a href="delete-division.php?id=<?php echo $row['id']; ?>">Delete</a></li>
												</ul>
											</div>
											</td>
                                        </tr>
